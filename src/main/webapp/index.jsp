				...
				<% if (success !=null) { %>
					...
					<% } %>
						...
						<header>
							<div class="header">
								<div class="logo">
									<img src="assets/images/b69f24d1a6b6244d359a5d7fc4729eae-removebg-preview.png"
						...
						<main>
							...
							<div class="hero-row" id="hero-section">
								...
								<img class="time-img" src="assets/images/21787145.jpg" alt="Time Illustration">
							</div>
							<!--hero section ends -->
							...
							<div class="report-row">
								<!--row5 report row-->
								<img src="assets/images/report3.gif" alt="gif" width="500px" height="500px">
						...
						<footer>
							...
							<div class="features">
								<h1>Features</h1>
								<a href="/">Home</a> <a href="<%=request.getContextPath()%>/signup.jsp">Task</a> <a
									href="<%=request.getContextPath()%>/signup.jsp">Timer</a> <a
							...
							<div class="social-icons">
								...
								<a href="https://www.facebook.com" target="_blank" class="fa fa-facebook"
									rel="noopener"></a> <a href="https://www.google.com" target="_blank"
									class="fa fa-google" rel="noopener"></a> <a href="https://www.linkedin.com"
									target="_blank" class="fa fa-linkedin" rel="noopener"></a> <a
									href="https://www.youtube.com" target="_blank" class="fa fa-youtube"
									rel="noopener"></a> <br> <a href="https://www.instagram.com" target="_blank"
									class="fa fa-instagram" rel="noopener"></a> <a href="https://www.twitter.com"
									target="_blank" class="fa fa-twitter" rel="noopener"></a>
							</div>
							<!-- social icon column starts -->
